...
ext_modules = [
    ...
    cpp_extension.CppExtension('pytorch_missing.search_cpu', ['pytorch_missing/csrc/search.cpp'], extra_compile_args=['-O3'])
]
...
if torch.cuda.is_available():
    ...
    ext_modules.append(cpp_extension.CUDAExtension('pytorch_missing.search_cuda', ['pytorch_missing/csrc/cuda/search.cu'], extra_compile_args={'cxx': ['-O3'], 'nvcc': ['-O3']}))
